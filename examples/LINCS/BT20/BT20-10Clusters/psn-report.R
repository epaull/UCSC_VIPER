...
permuted.scores = as.numeric(as.matrix(read.table(bg_file, sep="\t", header=FALSE))[,2])
...
plot(density(real.scores), col="black", lwd=2, main=paste(opt$tissue, " real (black) vs permuted (red) distributions"), xlab="Spearman Correlation to Centroid", xlim=c(0.5, 1))
